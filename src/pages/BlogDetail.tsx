...
function BlogDetail() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div
        className={`bg-gradient-to-br ${colors.gradient} text-white py-20 pt-32`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl">
            <div
              className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border backdrop-blur-sm mb-6 ${colors.tag}`}
            >
