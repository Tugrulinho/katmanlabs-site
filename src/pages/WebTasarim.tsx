      ...
      <div className="bg-[url('/images/web-tasarim-hero-mobile.png')] md:bg-[url('/images/web-tasarim-hero-desktop.png')] bg-cover bg-center text-white py-20 pt-32 min-h-[500px] flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="text-lg text-gray-200 max-w-4xl space-y-4 leading-relaxed">
            <p>
              Bugün bir web sitesi, şirketler için yalnızca "var olmak" anlamına
              gelmiyor. Potansiyel müşteriler, bir ürün ya da hizmetle
              ilgilenmeden önce çoğu zaman işletmenin web sitesine bakarak ilk
              izlenimini oluşturuyor.
            </p>
            <p>
              Küçük ya da büyük fark etmeksizin, web sitesi; ne yaptığınızı,
              nasıl çalıştığınızı ve ne kadar güvenilir olduğunuzu anlatan en
              temel dijital alanlardan biri.
            </p>
            <p>
              Katman Labs'ta web sitesini bu bakış açısıyla ele alıyor,
              abartıdan uzak ama işini doğru yapan yapılar kuruyoruz.
            </p>
          </div>
        </div>
      </div>
        ...
        <section id="web-tasarim-neden" className="mb-24">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl font-bold text-primary-dark mb-6">
                Şirketler İçin Web Sitesi Neden Zorunlu?
              </h2>
              <p className="text-gray-600 mb-8 text-lg leading-relaxed">
                Bir web sitesi artık yalnızca kartvizit yerine geçmiyor. Ürün ya
                da hizmetle ilgilenen biri için web sitesi, işletmenin kendini
                en net ifade ettiği alanlardan biri.
              </p>
              ...
              <div className="relative pl-6 border-l-4 border-accent-light">
                <p className="text-lg text-gray-700 font-medium italic">
                  Bu nedenle web sitesinin sadece "var olması" değil, doğru
                  çalışması ve anlaşılır olması önem kazanıyor.
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div className="md:order-2">
              <h2 className="text-3xl font-bold text-primary-dark mb-6">
                Biz Web Sitesini Nasıl Ele Alıyoruz?
              </h2>
              <div className="text-gray-600 space-y-4 text-lg leading-relaxed">
                <p>
                  Katman Labs'ta web tasarım ve geliştirme sürecine yalnızca
                  görsel bir çalışma olarak bakmıyoruz. Bir web sitesi; şirketin
                  ne yaptığını, kime hitap ettiğini ve nasıl bir yapı sunduğunu
                  ilk bakışta anlatabilen bir sistem olmalı.
                </p>
                <p>
                  Bu nedenle web sitesi çalışmalarında önceliğimiz; tasarım,
                  teknik altyapı ve ölçümleme bileşenlerinin bir bütün olarak
                  ele alınmasıdır. Güzel görünen ama yavaş çalışan, teknik
                  olarak doğru ama anlatımı zayıf siteler yerine, hem anlaşılır
                  hem sorunsuz yapılar kurmayı hedefliyoruz.
                </p>
                <p>
                  Web sitesini; ziyaretçinin kolayca gezebildiği, işletmenin
                  sunduğu ürün ya da hizmeti net şekilde anlayabildiği ve
                  gerektiğinde ölçümlenebilen bir dijital alan olarak
                  konumlandırıyoruz. Bu yaklaşım, sitenin yalnızca yayına
                  alınmasını değil, uzun vadede kullanılabilir ve
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-t-4 border-blue-500">
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Tasarım, yalnızca görsel beğeniyle ilgili bir konu değildir.
                  Bir sayfanın okunabilir olması, bilgilerin doğru hiyerarşiyle
                  sunulması ve ziyaretçinin aradığını kolayca bulabilmesi
            ...
            <div className="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-t-4 border-emerald-500">
              ...
              <div className="relative">
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  İyi görünen ama çalışmayan siteler yerine, hafif, hızlı ve
                  sorunsuz yapılar tercih edilir.
                </p>
                <ul className="space-y-3">
                  {[
            ...
            <div className="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border-t-4 border-orange-500">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl font-bold text-primary-dark mb-4">
                  Ölçüm ve Teknik Temel
                </h3>
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Bir web sitesinin gerçekten işe yarayıp yaramadığını anlamak
                  için ölçümleme şarttır. Bu nedenle her proje, temel teknik
                  kurulumlarla birlikte ele alınır.
                </p>
                <ul className="space-y-3">
                  {[
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center py-16">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Her işletmenin web sitesi ihtiyacı sıfırdan başlamak değildir.
                Mevcut bir web sitesi varsa, Katman Labs olarak önce bu yapıyı
                web tasarım, teknik altyapı ve performans açısından
                değerlendiriyoruz.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Çoğu durumda web sitesini tamamen yenilemek yerine, mevcut
                yapıyı iyileştirerek daha anlaşılır, daha hızlı ve daha işlevsel
                hale getirmek mümkündür. Bu yaklaşım, hem zaman hem maliyet
                açısından daha verimli bir çözüm sunar.
              </p>
            </div>
            ...
            <div className="relative min-h-[400px]">
              <div className="absolute inset-0 flex flex-wrap gap-4 justify-center items-center content-center">
                {[
                  {
                    text: "Güncel tasarım dili",
                    rotate: -3,
                    color: "from-blue-500 to-cyan-500",
                  },
                  {
                    text: "Mobil uyumluluğu",
                    rotate: 2,
                    color: "from-emerald-500 to-teal-500",
                  },
                  {
                    text: "Sayfa hızı ve teknik durumu",
                    rotate: -1,
                    color: "from-orange-500 to-red-500",
                  },
                  {
                    text: "İçerik yapısının ne kadar anlaşılır olduğu",
                    rotate: 3,
        ...
        <section id="calisma-seklimiz" className="mb-24">
          <div className="grid md:grid-cols-2 gap-12 items-center py-16">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Web tasarım ve geliştirme çalışmalarında süreci baştan
                netleştirerek ilerliyoruz. İhtiyaçlar belirlendikten sonra,
                proje kapsamı açık şekilde tanımlanır ve çalışma bu çerçeveye
                göre yürütülür.
              </p>
              <p className="text-lg text-gray-700 leading-relaxed">
                Katman Labs'ta web sitesi projeleri genellikle proje bazlı ele
                alınır. Bu sayede neyin yapılacağı, hangi aşamalardan geçileceği
                ve çalışmanın hangi noktada tamamlanacağı baştan bellidir.
              </p>
            </div>
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-xl border border-gray-200">
                ...
                <div className="space-y-4 mb-6">
                  {[
                    ...
                    {
                      text: "Sayfanın yapısal görünümü",
                      color: "bg-purple-500",
                    },
                    {
                      text: "Odaklandığımız anahtar kelimeler",
                      color: "bg-pink-500",
                    },
                    ...
                    <div key={idx} className="flex items-center gap-3 group">
                      <div
                        className={`w-2 h-2 rounded-full ${item.color} group-hover:w-3 group-hover:h-3 transition-all duration-300`}
                      ></div>
                      <span className="text-gray-700 group-hover:text-primary-dark transition-colors">
                        {item.text}
                      </span>
                    </div>
                  ))}
