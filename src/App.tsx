...
function HomePage() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      if (container.scrollLeft <= itemWidth) {
        ...
        container.scrollLeft = middlePoint + (container.scrollLeft - (maxScroll - itemWidth));
      }
    };
  ...
  const stats = [
    { number: content.stat_1_number || "150+", label: content.stat_1_label || "Mutlu Müşteri" },
    { number: content.stat_2_number || "%300", label: content.stat_2_label || "Ortalama ROI Artışı" },
    { number: content.stat_3_number || "50+", label: content.stat_3_label || "Aktif Proje" },
    { number: content.stat_4_number || "5+", label: content.stat_4_label || "Yıllık Deneyim" }
  ];

  const process = [
    { title: "Keşif & Analiz", description: "İş hedeflerinizi ve hedef kitlenizi derinlemesine analiz ediyoruz." },
    { title: "Strateji Geliştirme", description: "Size özel, veri odaklı dijital pazarlama stratejisi oluşturuyoruz." },
    { title: "Uygulama", description: "Planı hayata geçiriyoruz. Her katmanı özenle inşa ediyoruz." },
    { title: "Optimizasyon", description: "Sürekli izleme ve iyileştirme ile en iyi sonuçları garanti ediyoruz." }
  ];
  ...
  const testimonials = [
    {
      ...
      content: "katmanlabs ile çalışmaya başladıktan sonra online satışlarımız %200 arttı. Profesyonel yaklaşımları ve sonuç odaklı çalışmaları için teşekkür ederiz.",
      rating: 5
    },
    {
      name: "Ayşe Demir",
      role: "Kurucu, SaaS Startup",
      content: "Web sitemiz sadece görsel olarak değil, teknik açıdan da mükemmel. SEO çalışmaları sayesinde organik trafiğimiz 4 katına çıktı.",
      rating: 5
    },
    {
      name: "Mehmet Kaya",
      role: "Pazarlama Müdürü",
      content: "Katmanlı yaklaşımları sayesinde dijital varlığımızı adım adım inşa ettik. Her katman bir öncekini güçlendirdi.",
      rating: 5
    }
  ];
  ...
  const faqs = [
    {
      ...
      answer: "Web tasarım, dijital pazarlama ve SEO'yu birbirinden bağımsız değil, birbiriyle entegre katmanlar olarak görüyoruz. Her katman bir öncekini güçlendirir ve birlikte sağlam bir dijital varlık oluşturur.",
      icon: Layers,
    ...
    },
    {
      ...
      answer: "Başlangıç paketi için 2-3 hafta, Profesyonel paket için 4-6 hafta sürer. Kurumsal projeler için özel timeline oluşturulur.",
      icon: Clock,
    ...
    },
    {
      ...
      answer: "E-ticaret, SaaS, eğitim, sağlık, finans ve daha birçok sektörde deneyimimiz var. Her sektöre özel stratejiler geliştiriyoruz.",
      icon: Target,
    ...
    },
    {
      ...
      answer: "Web sitesi tesliminden hemen sonra görsel sonuçları görürsünüz. SEO ve pazarlama sonuçları genellikle 2-3 ay içinde belirgin hale gelir.",
      icon: Zap,
    ...
    },
    {
      ...
      answer: "Evet, tüm paketlerimizde destek hizmeti bulunur. Süre pakete göre değişir. Ayrıca aylık bakım paketleri de sunuyoruz.",
      icon: Award,
    ...
    },
    {
      ...
      answer: "Her projenin ihtiyaçları farklıdır. Başlangıç paketi 5.000₺'den başlar. Detaylı fiyatlandırma için paketlerimizi inceleyebilir veya özel teklif alabilirsiniz.",
      icon: HelpCircle,
    ...
    },
    {
      ...
      answer: "Banka havalesi, kredi kartı ve PayPal ile ödeme kabul ediyoruz. Kurumsal müşteriler için özel ödeme planları sunuyoruz.",
      icon: Users,
    ...
    },
    {
      ...
      answer: "Tüm paketlerimizde revizyon hakkı bulunur. Başlangıç paketinde 2, Profesyonel paketinde 4, Kurumsal pakette sınırsız revizyon hakkınız vardır.",
      icon: Star,
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-hero overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none z-5 overflow-hidden">
          ...
          <div className="absolute bottom-[8%] left-[25%] animate-float-medium" style={{ animationDelay: '2s' }}>
            <div className="relative">
          ...
          <div className="absolute bottom-[25%] left-[3%] animate-float" style={{ animationDelay: '3s' }}>
            <div className="relative">
          ...
          <div className="absolute top-[60%] right-[8%] animate-float-medium" style={{ animationDelay: '2.5s' }}>
            <div className="relative">
          ...
          <div className="absolute bottom-[35%] right-[20%] animate-float" style={{ animationDelay: '0.5s' }}>
            <div className="relative">
          ...
          <div className="absolute bottom-[10%] left-[15%] animate-float-slow opacity-60" style={{ animationDelay: '3.5s' }}>
            <div className="relative bg-white/5 backdrop-blur-sm p-2 rounded-xl border border-white/10">
              <Instagram className="w-6 h-6 text-pink-400" />
            </div>
          </div>

          <div className="absolute bottom-[5%] left-[35%] animate-float-medium opacity-60" style={{ animationDelay: '4s' }}>
            <div className="relative bg-white/5 backdrop-blur-sm p-2 rounded-xl border border-white/10">
              <Facebook className="w-7 h-7 text-blue-500" />
            </div>
          </div>

          <div className="absolute bottom-[12%] right-[30%] animate-float opacity-60" style={{ animationDelay: '4.5s' }}>
            <div className="relative bg-white/5 backdrop-blur-sm p-2 rounded-xl border border-white/10">
              <Youtube className="w-6 h-6 text-red-500" />
            </div>
          </div>

          <div className="absolute bottom-[8%] right-[15%] animate-float-medium opacity-60" style={{ animationDelay: '5s' }}>
            <div className="relative bg-white/5 backdrop-blur-sm p-2 rounded-xl border border-white/10">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 w-full pointer-events-none">
          <div className="max-w-xl lg:max-w-2xl text-center lg:text-left pointer-events-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-accent-light mb-8">
              ...
              <span className="text-sm font-medium">{content.hero_badge_text || 'Dijital Başarı İçin 4 Güçlü Hizmet'}</span>
            </div>

            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-white mb-6">
              {content.hero_title_line1 || 'Dijital Dünyada'}<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-light to-accent">{content.hero_title_line2 || 'Markanızı Büyütün'}</span>
            </h1>

            <p className="text-lg md:text-xl text-accent-light/90 mb-12 max-w-2xl mx-auto lg:mx-0">
              {content.hero_description || 'Sosyal medya, web tasarım, dijital pazarlama ve SEO hizmetleriyle markanızın dijital varlığını güçlendiriyoruz.'}
            </p>

            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center pointer-events-auto">
              <button onClick={() => scrollToSection('contact')} className="px-8 py-4 bg-gradient-cta text-white rounded-full font-semibold hover:scale-105 transition-transform shadow-lg flex items-center justify-center gap-2">
                {content.hero_cta_primary || 'Hemen Başla'} <ArrowRight className="w-5 h-5" />
              </button>
              <button onClick={() => scrollToSection('services')} className="px-8 py-4 border-2 border-white text-white rounded-full font-semibold hover:bg-white hover:text-primary transition-colors">
                {content.hero_cta_secondary || 'Hizmetleri Keşfet'}
              </button>
              <div className="hidden lg:block animate-float" style={{ marginLeft: '100px', animationDelay: '0s' }}>
                <div className="relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-accent-light/20 rounded-full text-primary mb-4">
              <Layers className="w-4 h-4" />
              <span className="text-sm font-medium">{content.services_badge || 'Profesyonel Hizmetler'}</span>
            </div>
          ...
          {servicesLoading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              const borderColor = service.featured ? '#ec4899' : index === 1 ? '#215080' : index === 2 ? '#676fbc' : '#cf99fa';
              const iconColor = service.featured ? '#ec4899' : index === 1 ? '#215080' : index === 2 ? '#676fbc' : '#cf99fa';

              return (
                <Link key={index} to={`/hizmet/${service.slug}`} className={`group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-t-4 cursor-pointer ${service.featured ? 'ring-2 ring-pink-500/20' : ''}`} style={{ borderTopColor: borderColor }}>
                  {service.featured && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8 items-center" style={{ minHeight: '300px' }}>
            <div className="flex flex-col justify-center h-full py-8">
              <h2 className="text-3xl md:text-4xl font-bold text-primary-dark mb-6">{content.about_title || 'Biz ne yapıyoruz ?'}</h2>
              <div className="text-gray-700 leading-relaxed space-y-4 text-base">
                <p>
                  {content.about_text_1 || 'Bugün sosyal medya, işletmeler için sadece bir paylaşım alanı değil; çoğu zaman ilk temas noktası.'}
                </p>
                <p>
                  {content.about_text_2 || 'Katman Labs olarak amacımız; küçük işletmeler için bu alanı rastgele değil, düzenli, anlaşılır ve markayı doğru yansıtan bir yapıya kavuşturmak.'}
                </p>
                <p>
                  {content.about_text_3 || 'Ürün de satsanız, hizmet de verseniz; sosyal medya profiliniz çoğu zaman satıştan önceki son durak.'}
                </p>
                <p className="font-semibold text-primary-dark">
                  {content.about_text_4 || 'Biz bu bütünlüğü kuruyor, sosyal medya hesaplarının sahipsiz kalmadan, düzenli bir şekilde devam etmesini sağlıyoruz.'}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center h-full">
              <div className="relative w-full h-[300px] rounded-2xl overflow-hidden shadow-2xl">
                <img
                  src={content.about_image_url || 'https://images.pexels.com/photos/607812/pexels-photo-607812.jpeg?auto=compress&cs=tinysrgb&w=800'}
      ...
      <section id="process" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-primary-dark mb-4">{content.process_title || 'Çalışma Sürecimiz'}</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {content.process_description || 'Başarılı projeler için kanıtlanmış 4 adımlık metodolojimiz'}
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="space-y-12">
              {process.map((step, index) => (
                <div key={index} className={`group flex items-center gap-8 ${index % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
                  <div className={`flex-1 ${index % 2 === 0 ? 'md:text-right' : 'md:text-left'}`}>
                    <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-2xl transition-shadow">
                      <h3 className="text-2xl font-bold text-primary-dark mb-3">{step.title}</h3>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
          <div className="text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-accent-light/20 rounded-full text-primary mb-4">
              ...
              <span className="text-sm font-medium">{content.blog_badge || 'Blog & İçerikler'}</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-primary-dark mb-4">{content.blog_title || 'Son Blog Yazılarımız'}</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              {content.blog_description || 'Dijital dünyadan güncel içerikler, trendler ve ipuçları'}
            </p>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {blogs.slice(0, 4).map((blog, index) => (
                ...
                >
                  <div className={`inline-block px-3 py-1 rounded-full text-xs font-medium border mb-4 ${getCategoryColor(blog.category)}`}>
                    {blog.category}
                  </div>
      ...
      <section id="pricing" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-primary-dark mb-4">{content.pricing_title || 'Paketlerimiz'}</h2>
            <p className="text-xl text-gray-600">{content.pricing_description || 'Her bütçeye uygun çözümler'}</p>
          </div>
          ...
          {packagesLoading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div key={index} className={`relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 ${pkg.popular ? 'border-2 border-transparent bg-gradient-to-br from-pink-50 to-orange-50 scale-105 ring-2 ring-pink-500/20' : 'border border-gray-200'}`}>
                {pkg.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="px-4 py-1 bg-gradient-to-r from-pink-500 to-orange-500 text-white rounded-full text-sm font-semibold shadow-lg">⭐ En Popüler</span>
                  </div>
                )}
                <h3 className="text-2xl font-bold text-primary-dark mb-2">{pkg.name}</h3>
                <div className="mb-6">
                  <span className={`text-4xl font-bold ${pkg.popular ? 'text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-orange-600' : 'text-transparent bg-clip-text bg-gradient-cta'}`}>{pkg.price}</span>
                  <span className="text-gray-600 ml-2">/ {pkg.period}</span>
                </div>
                <ul className="space-y-3 mb-8">
                  {pkg.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start gap-2">
                      <Check className={`w-5 h-5 flex-shrink-0 mt-0.5 ${pkg.popular ? 'text-pink-500' : 'text-secondary'}`} />
                      <span className="text-gray-700">{feature}</span>
                    </li>
                  ))}
                </ul>
                <button onClick={() => scrollToSection('contact')} className={`w-full py-3 rounded-lg font-semibold transition-all ${pkg.popular ? 'bg-gradient-to-r from-pink-500 to-orange-500 text-white hover:scale-105 shadow-lg' : 'border-2 border-primary text-primary hover:bg-primary hover:text-white'}`}>
                  Hemen Başla
                </button>
              </div>
              ))}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-pink-100 rounded-full text-pink-600 mb-4">
              ...
              <span className="text-sm font-medium">{content.testimonials_badge || 'Referanslarımız'}</span>
            </div>
            ...
            {[
              ...
              >
                <div className="flex flex-col items-center justify-center gap-4">
                  ...
                  <h3 className="text-lg font-bold text-primary-dark text-center">{brand.name}</h3>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full text-accent-light mb-4">
              ...
              <span className="text-sm font-medium">{content.faq_badge || 'Sıkça Sorulan Sorular'}</span>
            </div>
              ...
              return (
                ...
                >
                  <div className="absolute top-0 right-0 w-32 h-32 opacity-10">
                    <div className={`w-full h-full bg-gradient-to-br ${faq.gradient} rounded-full blur-2xl`}></div>
                  </div>
                  ...
                  >
                    <div className="flex-shrink-0">
                      <div className={`relative w-10 h-10 rounded-lg bg-gradient-to-br ${faq.gradient} flex items-center justify-center border border-white/20 transition-all duration-300 ${
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className={`text-base font-semibold transition-colors duration-300 ${
                        isActive ? 'text-accent-light' : 'text-white group-hover:text-accent-light'
                      }`}>
                        {faq.question}
                      </h3>
                    </div>

                    <div className={`flex-shrink-0 w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center transition-all duration-300 ${
                  ...
                  <div className={`overflow-hidden transition-all duration-500 ease-in-out ${
                    ...
                    <div className="px-4 pb-4">
                      <div className={`ml-14 p-4 rounded-lg bg-gradient-to-br ${faq.gradient} border border-white/10`}>
      ...
      <section id="contact" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-primary-dark mb-6">{content.contact_title || 'Projenizi Konuşalım'}</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${content.contact_email || 'info@katmanlabs.com'}`} className="text-primary hover:text-secondary transition-colors">{content.contact_email || 'info@katmanlabs.com'}</a>
                  </div>
                </div>
